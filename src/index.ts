    ...
    inputSchema: {
      ...
      properties: {
        ...
        model: {
          ...
          description: '3D generation model: seed3d (highest fidelity with PBR textures), hunyuan3d (best quality), trellis (good for objects), hunyuan-world (for scenes/worlds). Default: hunyuan3d',
        },
        variant: {
          type: 'string',
